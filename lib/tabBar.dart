...
class _SiteEngineerState extends State<SiteEngineer> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // ),
      body: Center(
        child: username == "MfLzGFHOCgW4i0pizrRXzH6Qpg23" ||
                username == "YKXs2gJG46hD3sYokfb22Ea64I22"||username=="rv8yBxkibrWTIQc1HxwF1t99Fme2"
            ? _widgetOptions.elementAt(_selectedIndex)
            : _widgetOptionss.elementAt(_selectedIndex),
      ),
